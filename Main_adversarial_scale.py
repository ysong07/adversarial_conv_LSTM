...
def train():
	...
	for step in xrange(FLAGS.max_step):
	    ...
	    G_model_1.input_frames_low_scale:temporal_up_scale(dat_down_4_past),G_model_1.future_frames_low_scale:temporal_up_scale(dat_down_4_fut)}
	    ...
	    dat[:,FLAGS.seq_start:,:,:,:],G_model_2.input_frames_low_scale:temporal_up_scale(dat_down_2_past),G_model_2.future_frames_low_scale: temporal_up_scale(dat_down_2_fut)}
