...
def train():
	...
	with tf.variable_scope("G_1") as scope:
            G_model_1 = G_scale_LSTM_high(scope=scope,scale_index=0,height=20,width=18,length=8,batch_size = FLAGS.batch_size,layer_num_lstm=2,kernel_size=[5,5],kernel_num=[128,128],future_seq_length=8,low_scale_graph = G_model_0,scope_string = "G_1")   
	...
	with tf.variable_scope("D_1") as scope:
        ...
        with tf.variable_scope("G_2") as scope:
            G_model_2 = G_scale_LSTM_high(scope=scope,scale_index=0,height=20,width=18,length=16,batch_size = FLAGS.batch_size,layer_num_lstm=2,kernel_size=[5,5],kernel_num=[128,128],future_seq_length=16,low_scale_graph = G_model_1,scope_string = "G_2")  
	...
	for step in xrange(FLAGS.max_step):
		...
		G_model_0.input_frames:dat_down_4_past,G_model_0.future_frames:dat_down_4_fut}
	    ...
	    dat[:,FLAGS.seq_start:,:,:,:],G_model_1.input_frames:dat_down_2_past, G_model_1.future_frames:dat_down_2_fut,\
                G_model_0.input_frames:dat_down_4_past,G_model_0.future_frames:dat_down_4_fut}
		...
		#    output_file = './imgs'+'/Ecog_'+str(step)+'_'+str(i)+'.pdf'
                    #data_handler.DisplayData_Ecog(dat,rec=dat[:,0:FLAGS.seq_start,:,:,:],fut=g_predict,case_id=i,output_file =output_file)
	#		
	    """ adding summary """
